...
var basicOnUpdateDeps = require('./data/basic-onUpdate-deps.raw');
...
describe('webcomponent', function () {
    ...
    test('Basic ForwardRef same as meta', function () {
        ...
        var output = (0, html_1.componentToCustomElement)()({ component: component });
        var outputMeta = (0, html_1.componentToCustomElement)()({ component: componentMeta });
    ...
    //   expect(output).toMatchSnapshot();
    // });
    test('Basic onUpdate deps', function () {
        var component = (0, jsx_1.parseJsx)(basicOnUpdateDeps);
        var output = (0, html_1.componentToCustomElement)()({ component: component });
        expect(output).toMatchSnapshot();
    });

                                    ...
                                    elements: [
                                        ...
                                        },
                                        {
                                            ...
                                            leadingComments: [
                                                {
                                                    type: 'CommentLine',
                                                    value: ' While this `components` object is deprecated, we must maintain support for it.',
                                                    start: 945,
                                                    end: 1026,
                                                    loc: {
                                                        start: {
                                                ...
                                                {
                                                    type: 'CommentLine',
                                                    value: ' Since users are able to override our default components, we need to make sure that we do not break such',
                                                    start: 1035,
                                                    end: 1141,
                                                    loc: {
                                                        start: {
                                                ...
                                                {
                                                    type: 'CommentLine',
                                                    value: ' This is why we spread `components` after the default Builder.io components, but before the `props.customComponents`,',
                                                    start: 1177,
                                                    end: 1296,
                                                    loc: {
                                                        start: {
                                                ...
                                                {
                                                    type: 'CommentLine',
                                                    value: ' which is the new standard way of providing custom components, and must therefore take precedence.',
                                                    start: 1305,
                                                    end: 1405,
                                                    loc: {
                                                        start: {
